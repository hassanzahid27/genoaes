...
//         {/* Text Section */}
//         <div className="bg-[#193E2C] flex flex-col gap-[14px] w-full xl:w-[55%]">
...
//           <p className="text-[#FCFAF2] font-light text-[20px] md:text-[26px] xl:text-[32px] leading-[28px] md:leading-[34px] xl:leading-[40px] px-[20px] md:px-[40px] xl:w-[810px]">
  ...
  return (
    <div className="max-w-[1800px] mx-auto pt-[80px]">
      <div className="flex flex-col lg:flex-row p-[20px] xl:p-[40px]">
        ...
        {/* Text Section */}
        <div className="bg-[#193E2C] flex flex-col gap-[14px] w-full xl:w-[55%] relative">
          <p className="text-[#43AA13] font-normal text-[24px] md:text-[28px] xl:text-[32px] leading-[32px] md:leading-[36px] xl:leading-[40px] p-[20px] md:px-[40px] md:pt-[40px] xl:pr-[70px]">
            Ready to Start Your Journey?
          </p>
