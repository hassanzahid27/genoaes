...
const N7 = () => {
  ...
  return (
    <div className="pt-[120px]">
      <p className=" px-[40px]  text-[#43AA13] text-lg font-normal text-[20px] md:text-[24px] leading-[28px] md:leading-[32px] tracking-[0]">
        What our past alumni say
      </p>

      {/* Divider line */}
      <div className="mt-6 px-[40px]  flex flex-col md:flex-row justify-between items-center pb-[40px] text-xs text-[#072661] mx-auto gap-2">
      ...
      <div className="flex flex-col lg:flex-row gap-[88px] pl-[40px]">
        <div
          ref={scrollRef}
