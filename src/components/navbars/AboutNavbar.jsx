...
const Abouttttt = () => {
  ...
  return (
    <div className="relative bg-[#193E2C] mb-[130px]">
          ...
          <div className="flex flex-col lg:flex-row items-center lg:items-start gap-10 lg:gap-[250px]">
            ...
            <div className="flex flex-col max-w-[640px] gap-[16px] text-center lg:text-left">
              ...
              <p className="roboto text-[#FCFAF2] font-light text-[18px] sm:text-[20px] lg:text-[24px] leading-[28px] sm:leading-[32px] tracking-[0]">
                We are a joint effort between the University of Genoa,
                companies, and institutions. Our is goal to empower
                international entrepreneurs through dynamic learning experiences
                with industry experts, companies and the University of
                Georgetown.
              </p>
            </div>
