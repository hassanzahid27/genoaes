  ...
  return (
    <div className="px-4 md:px-[40px] pt-[104px]">
      <div className="flex flex-col xl:flex-row gap-[40px] xl:gap-[165px]">
        {/* Left Heading */}
        <h1 className="onest font-light text-[24px] md:text-[32px] leading-[32px] tracking-[0] text-[#43AA13] xl:max-w-[210px]">
          How we help students grow
        </h1>

        {/* Right Content → scrollable but scrollbar hidden */}
        <div className="flex flex-row gap-[40px] md:gap-[80px] lg:gap-[140px] overflow-x-auto no-scrollbar">
          {/* First */}
          <div className="flex-shrink-0 min-w-[260px] flex flex-col gap-6 md:gap-[96px]">
            <h1 className="max-w-[320px] onest font-light text-[20px] md:text-[24px] leading-[28px] md:leading-[32px] text-[#000000]">
              Three mentor workshops per week
            </h1>
            <p className="max-w-[308px] text-[#202020] onest font-light text-[14px] md:text-[16px] leading-[22px] md:leading-[24px]">
          ...
          {/* Third */}
          <div className="flex-shrink-0 min-w-[260px] flex flex-col gap-6 md:gap-[96px]">
            <h1 className="max-w-[220px] onest font-light text-[20px] md:text-[24px] leading-[28px] md:leading-[32px] text-[#000000]">
