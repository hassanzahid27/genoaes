...
const WhyGenoa = () => {
  return (
    <div className="max-w-[1800px] mx-auto px-[16px] md:px-12 py-12 pt-[80px]">
      {/* Top heading */}
      <p className="text-[#43AA13] text-lg font-normal md:text-[24px] text-[20px] leading-[32px] tracking-[0]">
        Why
      ...
      <h2
        className="text-[28px] sm:text-[32px] md:text-[36px] lg:text-[40px]
             ...
             max-w-full md:max-w-[810px] mx-auto font-light tracking-[0] md:text-center text-left
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
        {/* Card 1 */}
        <div className="relative sm:justify-self-center sm:w-full md:w-auto md:pl-[24px] sm:col-span-1 lg:col-span-1">
        ...
        {/* Card 3 */}
        <div className="relative sm:col-span-2 lg:col-span-1 sm:justify-self-center md:pl-[24px] sm:w-full md:w-auto">
          {/* Border for tablet/desktop */}
          <div className="hidden sm:block absolute left-0 top-0 h-full w-[1px] bg-gradient-to-b from-[#43AA13] to-[#BCD4C7]"></div>
