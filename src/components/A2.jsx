    ...
    <div className="px-6 md:px-12 lg:px-[40px] py-[80px]  ">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-[#FAF5E2] p-6  max-w-[700px]">
          ...
          <p className="text-[#202020] text-sm md:text-base  lg:pt-[50px]   roboto font-normal text-[18px] leading-[24px] tracking-[0]  max-w-[552px]">
            Quality mentorship is essential for navigating startup complexities.
            A mentor provides tailored guidance, practical advice, and
            personalized feedback. Support from successful founders, investors,
            and leaders accelerates learning and increases success chances. With
            Genoa ES mentors, you are better prepared for obstacles and
            opportunities from idea inception to growth.
          </p>
        </div>
        ...
        <div className="bg-[#FAF5E2] p-6  max-w-[700px] ">
          ...
          <p className="text-[#202020] text-sm md:text-base  lg:pt-[50px]   roboto font-normal text-[18px] leading-[24px] tracking-[0]  max-w-[552px]">
            Real-world experience for startup founders is essential for gaining
            practical insights and understanding how to execute. Thanks to a
            tailored class schedule and living in the world’s best ecosystems,
            at Genoa ES, you have the time to apply immediately what you’ve
            learned and iterate fast, allowing for rapid growth of your startup
        ...
        <div className="bg-[#FAF5E2] p-6  max-w-[700px]">
          ...
          <p className="text-[#202020] text-sm md:text-base  lg:pt-[50px]   roboto font-normal text-[18px] leading-[24px] tracking-[0] max-w-[552px]">
            ...
            technical expertise necessary to execute tasks fast and effectively.
            Genoa ES mentors ensure you develop these skills through intense and
            highly focused workshops, followed by 1:1 meetings. So you will be
            ready to execute as if you had years of experience.
          </p>
        </div>
      </div>
    </div>
