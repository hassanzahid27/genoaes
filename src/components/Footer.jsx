...
//       <div className="flex flex-col lg:flex-row gap-[40px] lg:gap-[88px] py-[40px] lg:py-[80px]">
  ...
  return (
    <div className="px-[40px] relative">
      ...
      <div className="flex flex-col lg:flex-row gap-[40px] lg:gap-[88px] py-[40px] lg:py-[80px] relative">
        ...
        <div className="absolute right-[40px] bottom-62 lg:bottom-44 flex flex-col items-center">
